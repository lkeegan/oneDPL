                                         ...
                                         _InitType __init, _Res& __res, _Ranges&&... __rngs)
{
    ...
    if (__n <= 256)
    {
        return __parallel_transform_reduce_small_impl<__reduce_work_group_size, 1, _Tp>(
            ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init, __res,
            ::std::forward<_Ranges>(__rngs)...);
    }
    else if (__n <= 512)
    {
        return __parallel_transform_reduce_small_impl<__reduce_work_group_size, 2, _Tp>(
            ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init, __res,
            ::std::forward<_Ranges>(__rngs)...);
    }
    else if (__n <= 1024)
    {
        return __parallel_transform_reduce_small_impl<__reduce_work_group_size, 4, _Tp>(
            ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init, __res,
            ::std::forward<_Ranges>(__rngs)...);
    }
    else if (__n <= 2048)
    {
        return __parallel_transform_reduce_small_impl<__reduce_work_group_size, 8, _Tp>(
            ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init, __res,
            ::std::forward<_Ranges>(__rngs)...);
    }
    else if (__n <= 4096)
    {
        return __parallel_transform_reduce_small_impl<__reduce_work_group_size, 16, _Tp>(
            ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init, __res,
            ::std::forward<_Ranges>(__rngs)...);
    }
    else
    {
        return __parallel_transform_reduce_small_impl<__reduce_work_group_size, 32, _Tp>(
            ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init, __res,
            ::std::forward<_Ranges>(__rngs)...);
    }
}
                                       ...
                                       _InitType __init, _Res& __res, _Temp& __temp, _Ranges&&... __rngs)
{
    ...
    if (__n <= 2097152)
    {
        return __parallel_transform_reduce_mid_impl<__reduce_work_group_size, __reduce_iters_per_work_item, 1, _Tp>(
            ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init, __res, __temp,
            ::std::forward<_Ranges>(__rngs)...);
    }
    else if (__n <= 4194304)
    {
        return __parallel_transform_reduce_mid_impl<__reduce_work_group_size, __reduce_iters_per_work_item, 2, _Tp>(
            ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init, __res, __temp,
            ::std::forward<_Ranges>(__rngs)...);
    }
    else if (__n <= 8388608)
    {
        return __parallel_transform_reduce_mid_impl<__reduce_work_group_size, __reduce_iters_per_work_item, 4, _Tp>(
            ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init, __res, __temp,
            ::std::forward<_Ranges>(__rngs)...);
    }
    else if (__n <= 16777216)
    {
        return __parallel_transform_reduce_mid_impl<__reduce_work_group_size, __reduce_iters_per_work_item, 8, _Tp>(
            ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init, __res, __temp,
            ::std::forward<_Ranges>(__rngs)...);
    }
    else if (__n <= 33554432)
    {
        return __parallel_transform_reduce_mid_impl<__reduce_work_group_size, __reduce_iters_per_work_item, 16, _Tp>(
            ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init, __res, __temp,
            ::std::forward<_Ranges>(__rngs)...);
    }
    else
    {
        return __parallel_transform_reduce_mid_impl<__reduce_work_group_size, __reduce_iters_per_work_item, 32, _Tp>(
            ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init, __res, __temp,
            ::std::forward<_Ranges>(__rngs)...);
    }
}
